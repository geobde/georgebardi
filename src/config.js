const config = {
    footer: [
        {
            link: "https://www.linkedin.com/in/geobde",
            text: "Linkedin"
        },
        {
            link: "https://github.com/geobde",
            text: "GitHub"
        },
        {
    ...
    hero: {
     ...
     tagline: "Engineer specializing in Javascript & Web Performance. I currently work as Senior Frontend Engineer @ Intelligencia.",
    ...
    seo: {
        title: "George Bardi",
        description: "George Bardi | Senior Frontend Engineer"
    },
    notFound: {
        title: "Not Found",
